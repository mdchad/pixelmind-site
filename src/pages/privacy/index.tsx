			...
			<div className="rounded-xl overflow-hidden flex flex-col gap-5">
				<section className="h-[50vh] w-full bg-slate-50 flex justify-end flex-col gap-10 p-5 md:p-16 text-black rounded-2xl">
					<div className="w-full xl:w-[50%]">
						...
						<p>
							We care about your privacy and want you to
							understand how we collect, use, and share your
				...
				<section className="w-full bg-slate-50 flex justify-end flex-col gap-5 p-5 md:p-16 text-black rounded-2xl">
					<p>
						...
						website [insert website name here] (the "Site"). By
						using the Site, you consent to the collection, use, and
					...
					<p>
						...
						use the Site, such as your name, email address, and any
						other information that you choose to provide. We also
						collect information automatically when you use the Site,
						such as your IP address, browser type, and operating
						system.
					</p>
					...
					<p>
						We use your information to provide and improve the Site,
						to communicate with you about the Site and our services,
						and to personalize your experience on the Site. We may
						also use your information to comply with legal
						obligations, enforce our policies, and protect our
					...
					<p>
						...
						services. We may also share your information with our
						affiliates, business partners, and other third parties
						for marketing and promotional purposes. We may disclose
						your information if required by law or if we believe
						that such disclosure is necessary to protect our rights
					...
					<p>
						...
						of the Site. You can also opt-out of receiving
						promotional emails from us by following the instructions
						in those emails. Please note that even if you opt-out of
					...
					<p>
						...
						alteration, and destruction. However, please be aware
					...
					<p>
						...
						email (if we have your email address) or by posting a
						notice on the Site.
					</p>
