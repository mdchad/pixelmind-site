			...
			<div className="rounded-xl overflow-hidden flex flex-col gap-5">
				<section className="h-[50vh] w-full bg-slate-50 flex justify-end flex-col gap-10 p-5 md:p-16 text-black rounded-2xl">
					<div className="w-full xl:w-[50%]">
						<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">Terms & Condition</h1>
						<p>
				...
				<section className="w-full bg-slate-50 flex justify-end flex-col gap-10 p-5 md:p-16 text-black rounded-2xl">
					These Terms and Conditions ("Terms") govern your use of [insert website name here] (the "Site"). By accessing or using the Site, you agree to be bound by these Terms. If you do not agree to these Terms, you may not use the Site.

					<h2 className="text-lg font-bold">Use of Site</h2>

					<p>
						You may use the Site only for lawful purposes and in accordance with these Terms. You may not use the Site in any way that violates any applicable federal, state, local, or international law or regulation.
					</p>
					...
					<div className="flex flex-col gap-3">
						...
						<p>You may not copy, reproduce, distribute, modify, create derivative works of, publicly display, publicly perform, republish, download, store, or transmit any of the material on our Site, except as follows:</p>
					...
					<div className="flex flex-col gap-3">
						...
						<p>In any way that violates any applicable federal, state, local, or international law or regulation (including, without limitation, any laws regarding the export of data or software to and from the US or other countries).
						...
						<p>All User Contributions must comply with these Terms and any applicable laws and regulations. We have the right to remove any User Contributions that we consider to be inappropriate or objectionable.</p>
					</div>

					<h2 className="text-lg font-bold">Indemnification</h2>

					<p>You agree to defend, indemnify, and hold us harmless, our affiliates, licensors, and service providers, and our and their respective officers, directors, employees, contractors, agents, licensors, suppliers, successors, and assigns from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable attorneys' fees) arising out of or relating to your violation of these Terms or your use of the Site, including, but not limited to, your User Contributions, any use of the Site's content, services, and products other than as expressly authorized in these Terms, or your use of any information obtained from the Site.</p>

					<h2 className="text-lg font-bold">Disclaimer of Warranties</h2>
