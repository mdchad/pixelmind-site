		...
		<Layout>
			...
			<div className="rounded-xl overflow-hidden flex flex-col gap-5">
				...
				<section className="w-full bg-slate-50 flex justify-end flex-col gap-10 p-5 md:p-16 text-black rounded-2xl">
					These Terms and Conditions ("Terms") govern your use of [insert
					website name here] (the "Site"). By accessing or using the Site, you
					...
					<p>
						...
						these Terms. You may not use the Site in any way that violates any
					...
					<div className="flex flex-col gap-3">
						...
						<p>
							...
							RAM incidental to your accessing and viewing those materials. You
							may store files that are automatically cached by your Web browser
							for display enhancement purposes. You may print or download one
							copy of a reasonable number of pages of the Site for your own
							personal, non-commercial use and not for further reproduction,
							publication, or distribution. If we provide desktop, mobile, or
							other applications for download, you may download a single copy to
							your computer or mobile device solely for your own personal,
					...
					<div className="flex flex-col gap-3">
						...
						<p>
							...
							US or other countries). To engage in any other conduct that
							restricts or inhibits anyone's use or enjoyment of the Site, or
							which, as determined by us, may harm us or users of the Site or
							expose them to liability. User Contributions
						</p>
						...
						<p>
							All User Contributions must comply with these Terms and any
							applicable laws and regulations. We have the right to remove any
							User Contributions that we consider to be inappropriate or
							objectionable.
						</p>
					</div>
					<h2 className="text-lg font-bold">Indemnification</h2>
					<p>
						You agree to defend, indemnify, and hold us harmless, our
						...
						Site, including, but not limited to, your User Contributions, any
						use of the Site's content, services, and products other than as
