...
function HeadMeta({ title, description, keywords, image }: SEO) {
	const defaultTitle =
		'Pixelmind Studio | Building Bridges Between Business and Technology'
	const defaultDescription =
		'At Pixelmind Studio, we specialize in bridging the gap between business and technology. Our team delivers custom software solutions, web design, and digital marketing services that help businesses grow.'
	const defaultKey =
		'custom technology solutions, web design, software development, digital marketing, business growth, technology consulting, innovation, digital transformation, project management, user experience'
	const ogUrl = 'api/og'
	let ogImage = ''
		...
		<>
			...
			<Head>
				...
				<meta
					...
					content="zaNyWUg7p8IwSpbD_oEv_rVc8J_i4FGlHinRB3EZIZA"
				/>
			</Head>
		</>
	)
